// Escreva uma função, em C++, para imprimir a(s) folha(s) de maior nivel e a(s) folha(s) de menor 
// nivel, com os seus respectivos valores de nivel, de uma árvore binária.
