// Implemente uma função em C que receba a raiz e retorne o maior valor inteiro armazenado na árvore.
...
int main()
{
   ...
   cout << "O Maior Valor da arvore e: " << f1.MaiorValor(raiz);
